        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-slate-500 text-sm">
              © 2026 SportLyo. Tous droits réservés. Conception Plateforme{' '}
              <a href="https://www.webisula.com/" target="_blank" rel="noopener noreferrer" className="text-brand font-bold hover:underline">WEBISULA</a>.
            </p>
