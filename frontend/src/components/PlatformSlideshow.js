      ...
      <div className="max-w-sm mx-auto bg-white border border-slate-200 shadow-lg rounded overflow-hidden">
        ...
        <div className="p-3 space-y-2">
          ...
          <div className="space-y-1.5 pt-2">
            <div className="border rounded p-2 flex items-center gap-2 border-brand bg-brand/5"><CreditCard className="w-4 h-4 text-brand" /><span className="text-xs font-medium">Carte bancaire</span><span className="ml-auto text-[8px] text-slate-400">Visa, Mastercard</span></div>
          ...
          <p className="text-[7px] text-slate-400 text-center flex items-center justify-center gap-1"><Shield className="w-2.5 h-2.5" /> Paiement securise via Stripe — Commission transparente 5%</p>
        </div>
      </div>
    </div>
  </MockupFrame>
...
const slidesData = [
  ...
  { id: 'paiement', tag: 'Paiements', title: 'Paiement 100% securise', subtitle: 'commission transparente de 5%', bullets: ['Carte bancaire, Apple Pay, Google Pay', 'Commission transparente de 5%, zero frais caches', 'Paiement via Stripe, leader mondial', 'Codes promo et tarifs personnalisables'], icon: CreditCard, mockup: MockupPaiement, accent: '#8b5cf6' },
  ...
  { id: 'boutique', tag: 'Monetisation', title: 'Boutique zero stock', subtitle: 'vendez des produits a vos couleurs', bullets: ['T-shirts, gourdes, casquettes personnalises', 'Nos prestataires gerent stock et logistique', 'Commission sur chaque vente pour vous', 'Catalogue prestataire avec personnalisation logo'], icon: ShoppingBag, mockup: MockupBoutique, accent: '#f59e0b' },
