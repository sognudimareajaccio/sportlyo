...
LOGO_URL = os.environ.get("SITE_URL", "https://sports-event-tickets.preview.emergentagent.com") + "/logo-email.png"
SITE_URL = os.environ.get("SITE_URL", "https://sports-event-tickets.preview.emergentagent.com")
