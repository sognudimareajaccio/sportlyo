...
LOGO_URL = os.environ.get("SITE_URL", "https://sportlyo-bugs.preview.emergentagent.com") + "/logo-email.png"
SITE_URL = os.environ.get("SITE_URL", "https://sportlyo-bugs.preview.emergentagent.com")
