...
if not BASE_URL:
    BASE_URL = "https://sportlyo-events-1.preview.emergentagent.com"
...
class TestSelectionWorkflow:
    ...
    def test_customize_selection_product(self, provider_client):
        ...
        test_images = [
            "https://sportlyo-events-1.preview.emergentagent.com/uploads/test_custom_1.jpg",
            "https://sportlyo-events-1.preview.emergentagent.com/uploads/test_custom_2.jpg"
        ]
